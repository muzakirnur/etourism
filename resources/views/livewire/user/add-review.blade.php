<div id="reviewForm">
    ...
    <div class="p-2 grid grid-cols-2 gap-4">
            ...
            <div class="mb-4">
                <label for="countries" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Jenis Kunjungan</label>
                <select wire:model='jenis' id="jenis" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <div class="mb-4">
                ...
                <div class="flex flex-row p-4">
                    @for ($i = 1; $i < 6; $i++)
                    <svg wire:click="setStar({{ $i }})" id="{{ $i }}" class="w-4 h-4 me-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
