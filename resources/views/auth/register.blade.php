    ...
    <div class="w-full">
        <div class="bg-white p-4 rounded-lg">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="space-y-4">
                    <div>
                        <x-jet-label for="name">{{ __('Full Name') }} <span
                    ...
                    <div>
                        <x-jet-label for="umur">{{ __('Umur') }}<span
                                class="text-rose-500">*</span></x-jet-label>
                        <x-jet-input id="umur" type="number" name="umur" :value="old('umur')" required />
                    </div>

                    <div>
                        <x-jet-label for="alamat">{{ __('Alamat') }}<span
                                class="text-rose-500">*</span></x-jet-label>
                        <textarea name="alamat" id="alamat" class="form-input w-full" cols="30" rows="2"></textarea>
                    </div>

                    <div>
                        <x-jet-label for="jenis_kelamin">{{ __('Jenis Kelamin') }}<span
                                class="text-rose-500">*</span></x-jet-label>
                    ...
                    <div>
                        <x-jet-label for="pekerjaan">{{ __('Pekerjaan') }}<span
                                class="text-rose-500">*</span></x-jet-label>
                        <x-jet-input id="pekerjaan" type="text" name="pekerjaan" :value="old('pekerjaan')" required />
                    </div>

                    <div>
                        <x-jet-label for="password" value="{{ __('Password') }}"><span
                                class="text-rose-500">*</span></x-jet-label>
                        <x-login-password />
                    </div>

                    <div>
                        <x-jet-label for="password_confirmation" value="{{ __('Confirm Password') }}"><span
                                class="text-rose-500">*</span></x-jet-label>
